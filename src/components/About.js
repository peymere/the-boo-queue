...
function About() {
    return (
        <div className="about-container">
            ...
            <img className="img3" src="https://i.pinimg.com/736x/f4/5d/b3/f45db3c885293cba82e1ec3de979b995.jpg" alt="A ghost watching movies on the couch" height={400} />
            <h1 className="about-section-header header4">Stay Spooky</h1>
            <p className="about-text text3">
